...
-	[`27` (*aarch64//Dockerfile*)](https://github.com/fedora-cloud/docker-brew-fedora/blob/e1796b2753d5a5731de5915661e4639c4342b950/aarch64//Dockerfile)
-	[`26` (*aarch64//Dockerfile*)](https://github.com/fedora-cloud/docker-brew-fedora/blob/035aa2a3970e4e10a9a6ae0b79322b882bfe50d3/aarch64//Dockerfile)
-	[`30` (*aarch64//Dockerfile*)](https://github.com/fedora-cloud/docker-brew-fedora/blob/6ad27d8492f24d901ea53acc0cec84ffee5476d8/aarch64//Dockerfile)
-	[`28` (*aarch64//Dockerfile*)](https://github.com/fedora-cloud/docker-brew-fedora/blob/aa106da2be30656a7ccb32b96f6788031ce8656f/aarch64//Dockerfile)
-	[`latest`, `29` (*aarch64//Dockerfile*)](https://github.com/fedora-cloud/docker-brew-fedora/blob/4dbc2ccd3b4d52258981eaf12043025054d53023/aarch64//Dockerfile)
-	[`rawhide`, `31` (*aarch64//Dockerfile*)](https://github.com/fedora-cloud/docker-brew-fedora/blob/caac2827ca4312e0c917abb94d3b2141c56f863d/aarch64//Dockerfile)

[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/fedora/badge/icon) (`arm64v8/fedora` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/arm64v8/job/fedora/)
