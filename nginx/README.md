...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/nginx/badge/icon) (`ppc64le/nginx` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/ppc64le/job/nginx/)
