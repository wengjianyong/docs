...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/vault/badge/icon) (`amd64/vault` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/amd64/job/vault/)
