...
[![Build Status](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/vault/badge/icon) (`i386/vault` build job)](https://doi-janky.infosiftr.net/job/multiarch/job/i386/job/vault/)
